...
plugins=(git kubectl docker docker-compose helm aws kubetail)

source $ZSH/oh-my-zsh.sh
source /home/jim/.zsh_plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
#Kubes
alias dev="cd /shares/dev/"

function kap() { kubectl apply -f $1 }
function kcn() { kubectl config set-context --current --namespace="$1" }
